"""
NovaCortex v12.9.2 - FACULTY DATA MASTER 🏛️🔍
التاريخ: فبراير 2026

الميزات الجديدة:
1. [FIX-AB] Deep Faculty Search: تحسين استعلام البحث ليطلب البريد الإلكتروني والمكتب بالاسم الصريح.
2. [FIX-AC] The Proxy Prompt: إعادة صياغة السؤال داخلياً لتجاوز فلاتر الأمان.
3. [FIX-AD] Raw Data Extraction: استخراج البيانات الخام (إيميلات، مكاتب، أرقام) من السياق وعرضها فوراً.

الميزات في v12.9.1:
[FIX-Y] Public Data Authorization
[FIX-Z] Expanded Faculty Intent
[FIX-AA] Safety Refusal Bypass

الميزات في v12.9.0:
[FIX-U] Targeted Faculty Search
[FIX-V] Faculty Intent Detection
[FIX-W] Site-Specific Ranking
[FIX-X] Adaptive Faculty Bio

الميزات في الإصدارات السابقة:
[FIX-A] إلى [FIX-T] محفوظة بالكامل
"""
